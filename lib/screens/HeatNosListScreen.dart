...
import 'package:qmi_app/models/HeatNosListModel.dart';
...
class HeatNosListScreen extends StatefulWidget {

  const HeatNosListScreen({Key? key,}) : super(key: key);

  @override
  _HeatNosListScreen createState() => _HeatNosListScreen();
}

class _HeatNosListScreen extends State<HeatNosListScreen>{

  String strLoginId = "";
  String strLoginUserType = "";
  bool _isLoading = true;
  bool itemNotFound = false;
  HeatNosListModel? itemListModel;
  String strToken='';
  String strUserID='';
  ...
  Future<void> getHeatNosList() async {
    print(BaseURL.heatList);
    Dio dio = Dio();
    Response response = await dio.post(
        BaseURL.heatList+'sid='+strToken,
        options: Options(
    ...
    try {
      itemListModel = HeatNosListModel.fromJson(response.data);
                                                          ...
                                                          children: <Widget>[
                                                            ...
                                                            Container(
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: Align(
                                                                  alignment: Alignment.centerLeft,
                                                                  child: Text(itemListModel?.data?.response?[index].itemName??'',
                                                                    style:
                                                                    TextStyle(
                                                                      fontSize: 16,
                                                                      color: Colors.grey,
                                                          ...
                                                          children: <Widget>[
                                                            ...
                                                            Container(
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: Align(
                                                                  alignment: Alignment.centerLeft,
                                                                  child: Text(itemListModel?.data?.response?[index].name??'',
                                                                    style:
                                                                    TextStyle(
                                                                      fontSize: 16,
                                                                      color: Colors.grey,
